...
export const HOTSPOTS = {
  pass: [
    ...
    /* THE THREE TABLETS ON THE PASS.
       ...
       the glass on plates/pass.webp (luminance < 30 on the 2400x1340 file):
  ...
  freezer: [
    ...
    /* THE NOTE ON THE BACK WALL OF THE WALK-IN.
       ...
       MEASURED off plates/freezer.webp (2400x1340). The back wall is clear
       ...
       data/freezer.sealed.json (see build/seal-freezer.mjs and the gate note
