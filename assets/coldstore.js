 ...
 * What ships is a block of AES-256-GCM ciphertext — `data/freezer.sealed.json`,
 ...
 *     of data/tools.json, out of the network tab or out of the DOM. There is no
 ...
 *     tools themselves.
 *   IT DOES NOT hide the freezer's interior PHOTOGRAPH. `plates/freezer.webp` is
 ...
 */
export async function loadEnvelope(url = 'data/freezer.sealed.json') {
