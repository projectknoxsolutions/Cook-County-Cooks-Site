 ...
 * What ships is a block of AES-256-GCM ciphertext — `data/freezer.sealed.c772c92045.json`,
 ...
 *     of data/tools.3450a2cbfa.json, out of the network tab or out of the DOM. There is no
 ...
 */
export async function loadEnvelope(url = 'data/freezer.sealed.c772c92045.json') {
