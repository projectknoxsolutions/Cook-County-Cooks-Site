 ...
 * What ships is a block of AES-256-GCM ciphertext — `data/freezer.sealed.deaff5d10a.json`,
 ...
 */
export async function loadEnvelope(url = 'data/freezer.sealed.deaff5d10a.json') {
